 ...
 * @author Sameera
 */
public class FormMainFrame1 extends javax.swing.JFrame {
...
//
//        tblItemCart.getColumnModel().getColumn(2).setHeaderRenderer(cellRenderer);
//        tblItemCart.getColumnModel().getColumn(3).setHeaderRenderer(cellRenderer);
//        tblItemCart.getColumnModel().getColumn(4).setHeaderRenderer(cellRenderer);
    ...
    private void initComponents() {
        ...
        if (tblItemCart.getColumnModel().getColumnCount() > 0) {
            tblItemCart.getColumnModel().getColumn(0).setResizable(false);
            tblItemCart.getColumnModel().getColumn(0).setPreferredWidth(150);
            tblItemCart.getColumnModel().getColumn(1).setResizable(false);
            tblItemCart.getColumnModel().getColumn(1).setPreferredWidth(400);
            tblItemCart.getColumnModel().getColumn(2).setResizable(false);
            tblItemCart.getColumnModel().getColumn(2).setPreferredWidth(100);
            tblItemCart.getColumnModel().getColumn(3).setResizable(false);
            tblItemCart.getColumnModel().getColumn(3).setPreferredWidth(100);
            tblItemCart.getColumnModel().getColumn(4).setResizable(false);
            tblItemCart.getColumnModel().getColumn(4).setPreferredWidth(100);
        }
        ...
        btnNewOrder.setText("New Invoice");
                ...
                .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlMainLayout.createSequentialGroup()
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnNewOrder, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
                        ...
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(btnPayment, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnDiscount, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        pnlMainLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnDiscount, btnNewOrder});
        ...
        pnlMainLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtItemCode, txtQty});
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblLogoff, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel2.setText("Sameera Food City");
    ...
    private void txtItemCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtItemCodeActionPerformed
        try {
            ...
            Logger.getLogger(FormMainFrame1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnEnter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnter1ActionPerformed
        ...
        FormItemSearch search = new FormItemSearch(this, true, true);
    ...
    private void tblItemCartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblItemCartMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (tblItemCart.isRowSelected(selectedRow)) {
                ...
                double total = Double.parseDouble(Validator.BuildTwoDecimals(Double.parseDouble(tblItemCart.getValueAt(selectedRow, 4).toString())));
...
//                txtGrandTotal.setText(Validator.BuildTwoDecimals(this.grandTotal) + "");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FormMainFrame1().setVisible(true);
            }
        });
    }
    ...
    private void searchItem() throws ClassNotFoundException, SQLException {
        ...
        if (item != null) {
            txtItemPrice.setText(item.getSellingPrice() + "");
    ...
    private void addToCart() {
        ...
        double sellPrice = Double.parseDouble(Validator.BuildTwoDecimals(Double.parseDouble(txtItemPrice.getText().trim())));
        double total = 0;
            ...
            if (item.getMinusSell().equalsIgnoreCase("Yes")) {
                ...
                if ((Boolean) dopriceAndItemCodeExist[0]) {  // item code a does exist 
                    if ((Integer) dopriceAndItemCodeExist[1] != -1) {//price also exsist
                        ...
                        double newTotal = sellPrice * qty;
                        tableModel.setValueAt(Validator.BuildTwoDecimals(qty), (Integer) dopriceAndItemCodeExist[1], 2);
                        tableModel.setValueAt(Validator.BuildTwoDecimals(newTotal), (Integer) dopriceAndItemCodeExist[1], 4);
                    } else {
                        total = sellPrice * qty;
                        Object ob[] = {itemCode, itemName, Validator.BuildTwoDecimals(qty), Validator.BuildTwoDecimals(sellPrice), Validator.BuildTwoDecimals(total)};
...
//                txtItemCode.requestFocus();
    ...
    private void deleteLine() {
        ...
        if (tblItemCart.isRowSelected(selectedRow)) {            
            ...
            JOptionPane.showMessageDialog(null, "Please select a item to delete from order.", "No item selected", JOptionPane.WARNING_MESSAGE);
        }
    }
